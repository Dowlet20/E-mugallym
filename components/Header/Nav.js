...
{/*1 <li className="with-megamenu has-menu-child-item position-static">
  <Link
...
{/*2 <li className="with-megamenu has-menu-child-item">
  <Link
...
{/*4 <li className="with-megamenu has-menu-child-item position-static">
  <Link
    href="#"
    className={`${activeMenuItem === "pages" ? "open" : ""}`}
    onClick={() => toggleMenuItem("pages")}
...
{/*5 <li className="with-megamenu has-menu-child-item position-static">
  <Link
    href="#"
...
{/* 6 <li className="with-megamenu has-menu-child-item position-static">
  <Link
    href="#"
