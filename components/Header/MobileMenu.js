            ...
            <ul className="navbar-top-left rbt-information-list justify-content-start">
              <li>
                <Link href="mailto:hello@example.com">
                  <i className="feather-mail"></i>emugallym.com
                </Link>
              </li>
              <li>
                <Link href="#">
                  <i className="feather-phone"></i>993 12 945155
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div className="mobile-menu-bottom">
            <div className="rbt-btn-wrapper mb--20">
              <Link
                ...
                href="#"
              >
                <span>Kursa ýazyl</span>
              </Link>
            </div>

            <div className="social-share-wrapper">
              <span className="rbt-short-title d-block">Biz bilen kämilleş</span>
